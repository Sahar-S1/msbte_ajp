...
public class Prog03_Multiply {
    ...
    public static GridBagConstraints getGridBagConstraints(int x, int y) {
        return getGridBagConstraints(x, y, 1);
    }
    ...
    public static void main(String[] args) {
        ...
        JButton multiplyButton = getButton("Multiply");
        ...
        int row = 0;
        contentPane.add(num1Label, getGridBagConstraints(0, row));
        contentPane.add(num1TextField, getGridBagConstraints(1, row));
        row++;
        contentPane.add(num2Label, getGridBagConstraints(0, row));
        contentPane.add(num2TextField, getGridBagConstraints(1, row));
        row++;
        contentPane.add(resLabel, getGridBagConstraints(0, row));
        contentPane.add(resTextField, getGridBagConstraints(1, row));
        row++;
        contentPane.add(multiplyButton, getGridBagConstraints(0, row, 2));
