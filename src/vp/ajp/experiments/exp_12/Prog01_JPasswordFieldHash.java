...
public class Prog01_JPasswordFieldHash {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("JPasswordField Echo Char #");
        ...
        JLabel titleLabel = getLabel("Login");
        ...
        JButton submitButton = getButton("Submit");
        ...
        row++;
        contentPane.add(submitButton, getGridBagConstraints(0, row, 2));
